...
api_router.include_router(scheduling.router, prefix="", tags=["Scheduling"])
api_router.include_router(communication.router, prefix="/communications", tags=["Communication"])
